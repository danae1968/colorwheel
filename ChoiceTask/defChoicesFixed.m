...
if pms.practice == 1
    ...
    pms.numPairs2 = pms.numPairs2Prac;
    pms.numChoices1=pms.numChoices1Prac;
    pms.numChoices2=pms.numChoices2Prac;
    pms.easyOffer1=pms.easyOffer1Prac;
    pms.easyOffer2=pms.easyOffer2Prac;
    ...
    version2=2*ones(pms.numChoices2/pms.numBlocks,1); %direct comparison
    typeVector1=repmat(pms.typeTask1,pms.numPairs1*pms.reps/pms.numBlocks,1);typeVector1=typeVector1(:);
    typeVector2=repmat(pms.typeTask2,pms.numPairs2*pms.reps/pms.numBlocks,1);typeVector2=typeVector2(:);
    easyOffer1=repmat(pms.easyOffer1', pms.numChoices1/(pms.numBlocks*pms.numPairs1),1);
    easyOffer2=repmat(pms.easyOffer2',pms.numChoices2/(pms.numPairs2*pms.numBlocks),1);
